...
int fileSize = 10 * 1024 * 1204; // 1000 -> 1K, 1000K -> 1M, 1000M -> 1G, 1000G -> 1T

// 파일의 정보를 처리해 주는 객체 생성 -> 파일 업로드가 자동으로 이루어진다.
// new MultipartRequest(request, 실제적인 저장위치 - 컴퓨터에서, 파일 용량제한, 인코딩방식, 중복된 파일이름처리객체)
MultipartRequest multi = new MultipartRequest(request, realPath, fileSize, 
		"utf-8", new DefaultFileRenamePolicy());
// MultipartRequest에서 생성 후 request에서는 아무것도 나오지 않는다.

...
public class MemberDAO {
	...
	public MemberVO view(String id) throws Exception {
		...
		try {
			...
			// 3. 4.
			// 실행쿼리 확인
			System.out.println("MemberDAO.view().DBSQL.MEMBER_VIEW: " + DBSQL.MEMBER_VIEW);
			...
			// TODO: handle exception
			e.printStackTrace();
			throw new Exception("회원 정보 보기 DB 처리 중 오류");
		} finally {
			DBInfo.close(con, pstmt, rs);
		}
	...
	public Integer write(MemberVO vo) throws Exception {
		...
		try {
			...
			// 3. 4.
			// 실행쿼리 확인
			System.out.println("MemberDAO.write().DBSQL.MEMBER_VIEW: " + DBSQL.MEMBER_WRITE);
	...
	public String checkId(String id) throws Exception {
		...
		try {
			...
			// 3. 4.
			// 실행쿼리 확인
			System.out.println("MemberDAO.write().DBSQL.MEMBER_VIEW: " + DBSQL.MEMBER_CHECK_ID);
